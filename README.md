...
| `status-list-server-url`                        | URL of the status list server (required; the plugin fails if not configured). You may try our public instance at `https://statuslist.eudi-adorsys.com` | *None*           |
