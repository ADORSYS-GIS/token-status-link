...
public class StatusListProtocolMapper extends OID4VCMapper {
    ...
    public Status sendStatusAndStoreIndexMapping(
        ...
        if (!reserveIndex(mapping, maxCredentialsPerUser, overflowPolicy)) {
            return null;
        }
    ...
    private boolean reserveIndex(StatusListMappingEntity mapping, int maxCredentialsPerUser, String overflowPolicy) {
        logger.debugf(
